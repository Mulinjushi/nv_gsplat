...
SOURCE_PATH="${BASE_DIR}/data/${SCENE}/2k_all_cams"
MODEL_PATH="${BASE_DIR}/models/${SCENE}_2k_all_cams"
NAME="${SCENE}_2k_all_cams"
...
python examples/render.py \
    ...
    --crop_hfov_camera_ids 4 5 6 \
    --crop_vfov_deg 75 \
    --ply_path $MODEL_PATH/ply/point_cloud_239999.ply \
    --channels 2 1 3 5 4 6\
    --result_dir $MODEL_PATH/video \
    --fps 15 \
    --ckpt_path $MODEL_PATH/ckpts/ckpt_239999_rank0.pt \
    --output_name ${model_name}ckpt239999_final.mp4 \
    --use_sky \

...
SOURCE_PATH="${BASE_DIR}/data/${SCENE}/5k_all_cams"
MODEL_PATH="${BASE_DIR}/models/ablation/${SCENE}_5k_all_cams_no_ground"
NAME="${SCENE}_5k_all_cams"
...
export WANDB_API_KEY=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
export WANDB_INSECURE_DISABLE_SSL=true
export WANDB_SILENT=true
export OMP_NUM_THREADS=1
export PYTHONWARNINGS="ignore:The pynvml package is deprecated"

PROJECT_NAME=scale_exp
EXPERIENT_NAME="${NAME}"
max_steps=600000
means_lr=2e-3
noise_lr=5e2
...
torchrun --standalone \
     ...
     --sh_degree 1 \
     --eval_steps 5000 10000 20000 30000 40000 50000 60000 70000 80000 90000 100000 110000 120000 130000 140000 150000 160000 170000 180000 190000 200000 225000 250000 275000 300000 325000 350000 375000 400000 425000 450000 475000 500000 525000 550000 575000 $max_steps \
...
python examples/render.py \
    ...
    --crop_hfov_camera_ids 4 5 6 \
    --crop_vfov_deg 75 \
    --ply_path $MODEL_PATH/ply/point_cloud_599999.ply \
    --channels 2 1 3 5 4 6\
    --result_dir $MODEL_PATH/video \
    --fps 15 \
    --ckpt_path $MODEL_PATH/ckpts/ckpt_599999_rank0.pt \
    --output_name ${model_name}ckpt599999_final.mp4 \
    --use_sky \
    --pose_opt --pose_opt_lr $pose_opt_lr  --pose_opt_start $pose_opt_start --pose_opt_mode 'rig' --pose_opt_reg $pose_opt_reg \
...
SOURCE_PATH="${BASE_DIR}/data/${SCENE}/0.5k_all_cams"
MODEL_PATH="${BASE_DIR}/models/ablation/${SCENE}_0.5k_all_cams_no_ground"
NAME="${SCENE}_0.5k_all_cams"
...
python examples/render.py \
    ...
    --output_name ${model_name}ckpt149999_final.mp4 \
    --use_sky \
    --pose_opt --pose_opt_lr $pose_opt_lr  --pose_opt_start $pose_opt_start --pose_opt_mode 'rig' --pose_opt_reg $pose_opt_reg \